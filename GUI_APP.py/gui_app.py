...
ttk.Label(app,textvariable=msg).place(x=50,y=70)
def abc():
    print('Wow')
    msg.set('Whatever')
ttk.Button(app, text='click it!!', command=abc).place(x=100,y=100)
ttk.Button(app, text='click it!!', command=lambda:print('Wow!!')).place(x=100,y=130)
ttk.Button(app, text='click it!!', font=('Arial',25), command=lambda:msg.set('Wow!!')).place(x=100,y=170)
f1=ttk.Variable(app)
f1.set('0')
f2=ttk.Variable(app)
f2.set('0')
